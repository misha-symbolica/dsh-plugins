...
// ---- registration per agent (no process is spawned at registration)
{
  ...
  const expected = ['mcp__chrome__click', 'mcp__chrome__close', 'mcp__chrome__console_messages', 'mcp__chrome__evaluate', 'mcp__chrome__fill', 'mcp__chrome__fill_form', 'mcp__chrome__get_screenshot', 'mcp__chrome__hover', 'mcp__chrome__navigate', 'mcp__chrome__network_requests', 'mcp__chrome__open', 'mcp__chrome__press_key', 'mcp__chrome__save_screenshot', 'mcp__chrome__snapshot', 'mcp__chrome__type_text', 'mcp__chrome__wait_for', 'mcp__safari__close', 'mcp__safari__console_messages', 'mcp__safari__evaluate', 'mcp__safari__get_page_content', 'mcp__safari__get_screenshot', 'mcp__safari__get_youtube_notes', 'mcp__safari__interact', 'mcp__safari__navigate', 'mcp__safari__network_requests', 'mcp__safari__open', 'mcp__safari__save_screenshot', 'mcp__safari__set_viewport_size']
  ...
  const shot = registered.get('top:mcp__safari__get_screenshot')
  if (typeof shot.finalizeContent !== 'function' || shot.parameters.properties.querySelector === undefined) fail('mcp__safari__get_screenshot shape')
