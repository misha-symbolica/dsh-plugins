...
// ---- registration per agent (no process is spawned at registration)
{
  ...
  const expected = ['chrome_click', 'chrome_close', 'chrome_console_messages', 'chrome_evaluate', 'chrome_fill', 'chrome_fill_form', 'chrome_get_screenshot', 'chrome_hover', 'chrome_navigate', 'chrome_network_requests', 'chrome_open', 'chrome_press_key', 'chrome_save_screenshot', 'chrome_snapshot', 'chrome_type_text', 'chrome_wait_for', 'safari_close', 'safari_console_messages', 'safari_evaluate', 'safari_get_page_content', 'safari_get_screenshot', 'safari_get_youtube_notes', 'safari_interact', 'safari_navigate', 'safari_network_requests', 'safari_open', 'safari_save_screenshot', 'safari_set_viewport_size']
