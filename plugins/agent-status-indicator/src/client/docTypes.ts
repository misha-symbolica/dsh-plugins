...
export const DOC_TYPES: readonly DocType[] = [
  ...
  { id: 'css', name: 'css', brand: 'css.svg', deco: 'custom-css.svg', bg: '#264de4', fg: '#ffffff', exts: ['css', 'scss', 'less'] },
  ...
  { id: 'exe', name: 'executable', brand: 'exe.svg', deco: 'exe.svg', bg: '#e64a19', fg: '#ffffff', exts: ['exe', 'msi'] },
  { id: 'tex', name: 'latex', brand: 'tex.svg', deco: 'tex.svg', bg: '#2196f3', fg: '#ffffff', exts: ['tex', 'bib'] },
  { id: 'img', name: 'image', brand: 'image.svg', deco: 'custom-img.svg', bg: '#26a69a', fg: '#ffffff', exts: ['png', 'jpg', 'jpeg', 'gif', 'webp', 'bmp', 'ico', 'avif'] },
  { id: 'pdf', name: 'pdf', brand: 'pdf.svg', deco: 'custom-pdf.svg', bg: '#d32f2f', fg: '#ffffff', exts: ['pdf'] },
  { id: 'diff', name: 'diff', brand: 'diff.svg', deco: 'custom-diff.svg', bg: '#00897b', fg: '#ffffff', exts: ['diff', 'patch'] },
  { id: 'xml', name: 'xml', brand: 'xml.svg', deco: 'custom-xml.svg', bg: '#8bc34a', fg: '#1b1b1d', exts: ['xml'] },
  ...
  { id: 'csv', name: 'csv', brand: 'csv.svg', deco: 'custom-csv.svg', bg: '#217346', fg: '#ffffff', exts: ['csv', 'tsv'] },
