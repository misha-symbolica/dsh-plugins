...
export const DOC_TYPES: readonly DocType[] = [
  ...
  { id: 'img', name: 'image', brand: 'image.svg', badge: 'image.svg', deco: 'custom-img.svg', decoBg: '#26a69a', bg: '#26a69a', fg: '#ffffff', exts: ['png', 'jpg', 'jpeg', 'gif', 'webp', 'bmp', 'ico', 'avif'] },
  ...
  { id: 'swift', name: 'swift', brand: 'swift.svg', badge: 'swift.svg', deco: 'material-swift.svg', bg: '#f05138', fg: '#ffffff', exts: ['swift'] },
  ...
  { id: 'r', name: 'r', brand: 'lang-r.svg', deco: 'devicon-r.svg', bg: '#276dc3', fg: '#ffffff', exts: ['r'] },
