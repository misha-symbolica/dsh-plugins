...
export const DOC_TYPES: readonly DocType[] = [
  ...
  { id: 'txt', name: 'text', svg: 'txt.svg', bg: '#6d6d72', fg: '#ffffff', exts: ['txt', 'text'] },
  { id: 'log', name: 'log', svg: 'log.svg', bg: '#afb42b', fg: '#1b1b1d', exts: ['log'] },
  { id: 'exe', name: 'executable', svg: 'exe.svg', bg: '#e64a19', fg: '#ffffff', exts: ['exe', 'msi'] },
  { id: 'tex', name: 'latex', svg: 'tex.svg', bg: '#2196f3', fg: '#ffffff', exts: ['tex', 'bib'] },
  { id: 'img', name: 'image', svg: 'image.svg', bg: '#26a69a', fg: '#ffffff', exts: ['png', 'jpg', 'jpeg', 'gif', 'webp', 'bmp', 'ico', 'avif'] },
  { id: 'pdf', name: 'pdf', svg: 'pdf.svg', bg: '#d32f2f', fg: '#ffffff', exts: ['pdf'] },
  { id: 'diff', name: 'diff', svg: 'diff.svg', bg: '#00897b', fg: '#ffffff', exts: ['diff', 'patch'] },
