...
# artwork's own red #ef5350. Fit measured: bbox (5.25,7.97)-(17.63,19.59).
...
<defs><mask id="m" maskUnits="userSpaceOnUse" x="0" y="0" width="128" height="128">
<g transform="translate(-43.21,-65.18) scale(9.373)">
<rect x="4" y="8" width="14.5" height="12" fill="#fff"/>
<path d="{PDF_PAGE_D}" fill="#000"/>
<rect x="12.8" y="7.5" width="6.2" height="1.9" fill="#000"/>
</g></mask></defs>
<rect width="128" height="128" fill="#ffffff" mask="url(#m)"/>
</svg>
'''
